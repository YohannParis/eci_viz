(function () {
    function app() {
        ...
        var form = d3.select("#participation_interactive_div").append("form");
        ...
        function change(data) {
            ...
            var div = d3.select("#participation_interactive_div").append("div").attr("id", "participation_interactive_div").attr("class", "toolTip");
